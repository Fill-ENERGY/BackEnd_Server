...
public interface StationRepository extends JpaRepository<Station, Long> {
    ...
    @Query(value = "SELECT s FROM Station s WHERE s.id > :lastId ORDER BY s.score DESC")
    Slice<Station> findAllByOrderByScoreDescFromId(Long lastId, Pageable pageable);

    Slice<Station> findAllByOrderByScoreDesc(Pageable pageable);
